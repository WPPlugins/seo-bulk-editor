jQuery(document).ready( function() {
    ...
    var existing_title_id   = "#seo-bulk-editor-existing-title-";
    var new_title_id        = "#seo-bulk-editor-new-title-";
    var new_title_class     = ".seo-bulk-editor-new-title";
    
    var existing_metadesc_id   = "#seo-bulk-editor-existing-metadesc-";
    var new_metadesc_id        = "#seo-bulk-editor-new-metadesc-";
    var new_metadesc_class     = ".seo-bulk-editor-new-metadesc";
	...
	var submit_new = function( id ) {
		if( jQuery( '.seo_bulk_editor_titles' ).length == 1 ) {
			submit_new_title( id );
		} else if( jQuery( '.seo_bulk_editor_descriptions').length == 1 ) {
	...
	var submit_new_title = function( id ) {
		...
		var data = {
			'action': 'seo_bulk_editor_save_title',
			'seo_bulk_editor_post_id': id,
	...
	var submit_new_metadesc = function( id ) {
		...
		var data = {
			'action': 'seo_bulk_editor_save_desc',
			'seo_bulk_editor_post_id': id,
	...
	jQuery.each( jQuery('.seo-bulk-editor-save'), function() {
	...
	jQuery.each( jQuery('.seo-bulk-editor-save-all'), function() {
		var save_all_titles = function() {

			var data = {
				'action': 'seo_bulk_editor_save_all_titles'
			};
		...
		var save_all_metadescs = function() {
			...
			var data = {
				'action': 'seo_bulk_editor_save_all_descs'
			};
